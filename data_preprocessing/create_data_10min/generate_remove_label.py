...
## Generate remove label on all of the patients
## in 90 min the removed label is only on seizure free patients
def get_remove_label(input_dir, annotation_fn, inference_res90min):
    ...
    for pn in os.listdir(input_dir):
        ...
        np.savez(os.path.join(patient_folder,"remove_label.npz"),\
...
if __name__ == "__main__":
    ...
    get_remove_label(args.dataout_10, args.channel_annotation, None)