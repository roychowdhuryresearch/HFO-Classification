...
def extract_features_perpatient(folder, patient_names, feature_param, outfolder):
    ...
    np.savez_compressed(os.path.join(outfolder, "data.npz"), feature=feature, starts=starts, ends=ends, channel_names=channel_names, labels = annotation_df['labels'].values)
